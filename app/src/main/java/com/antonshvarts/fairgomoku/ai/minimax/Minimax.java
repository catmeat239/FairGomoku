...
public class Minimax {
    ...
    public int[] calculateNextMove(int depth) {
        // todo Block the board for AI to make a decision.
        ...
        String logString = ("Cases calculated: " + evaluationCount + "\n Calculation time: " + (System.currentTimeMillis() - startTime) + " ms");
        Log.d("Game","Minimax info: \n"+logString);
